...
mvn install:install-file -Dfile=libsToInstallMaven/secondstring-20060615.jar  -DgroupId=com.wcohen.ss -DartifactId=secondstring  -Dversion=2.5 -Dpackaging=jarcom.wcohen.ss
